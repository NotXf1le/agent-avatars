...
Use the private security-advisory form in the GitHub repository that hosts this source. Do not include secrets, personal data, or exploit details in a public issue. Include affected versions, a minimal reproducer, impact, and any known mitigations.
